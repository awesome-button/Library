...
function eventController() {
    ...
    //We iterate through our array of books and create a book instance from each object/book of the array.
    ...
    function createLibrary(books) {
        let library = new Library(); // a new instance if Library class
        for (let i = 0; i < books.length; i++) { // looping through array of book objects
            library.add(books[i]); // adding books to the library
